            ...
            <Container>
                <section className="my-32">
                    ...
                    <div className="max-w-4xl mx-auto text-center mb-16">
                        <h1 className="text-5xl font-extrabold mb-4 tracking-tight text-[#25A8D6]">
                            About MedEasy
                        </h1>
                    ...
                    <div className="text-center">
                        <a href="/shop" className="px-6 py-3 bg-[#25A8D6] text-white font-semibold rounded-lg shadow hover:bg-[#1e8bb4] transition">
                            Explore Medicines
                        </a>
                    </div>
                </section>
